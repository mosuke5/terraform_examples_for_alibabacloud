...
wget https://raw.githubusercontent.com/mosuke5/terraform_for_alibabacloud_examples/add/wordpress-advanced/wordpress_advanced_sample/playbook_fumidai.yml -O playbook.yml
